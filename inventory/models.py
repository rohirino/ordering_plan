...
class Product(models.Model):
    ...
    order_interval_days = models.PositiveIntegerField(verbose_name="分割発注間隔（日）", default=0)
...
class Order(models.Model):
    ...
    order_date = models.DateField(verbose_name="発注予定日", null=True, blank=True)
    expected_arrival_date = models.DateField(verbose_name="入荷予定日", null=True, blank=True)
